...
--TRAJECTORY_BUILDER_2D.ceres_scan_matcher.occupied_space_weight = 2e6

TRAJECTORY_BUILDER_2D.ceres_scan_matcher.translation_weight = 1e2
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 2e5



TRAJECTORY_BUILDER_2D.submaps.num_range_data = 70
TRAJECTORY_BUILDER_2D.motion_filter.max_distance_meters = 0.1
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians = math.rad(50)
